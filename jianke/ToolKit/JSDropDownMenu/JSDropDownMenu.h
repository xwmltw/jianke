...
@protocol JSDropDownMenuSelectDelegate <NSObject>
...
@property (nonatomic, assign) BOOL isViewAllParttime;   /*!< 控制查询条件 - 直通车查询 */
@property (nonatomic, weak) id <JSDropDownMenuDataSource> dataSource;
@property (nonatomic, weak) id <JSDropDownMenuDelegate> delegate;
@property (nonatomic, weak) id <JSDropDownMenuSelectDelegate> selectDelegate;

@property (nonatomic, strong) UIColor *indicatorColor;
@property (nonatomic, strong) UIColor *textColor;
@property (nonatomic, strong) UIColor *separatorColor;

@property (nonatomic, strong) UIColor *indicatorHightColor;
@property (nonatomic, strong) UIColor *textHightColor;
