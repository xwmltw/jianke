...
+ (void)sheetWithTitle:(NSString*)title buttonTitleArray:(NSArray *)titleArray isNeedCancelButton:(BOOL)isNeedCancelButton maxShowButtonCount:(CGFloat)maxShowBtnCount block:(MKActionSheetBlock)block{
    MKActionSheet *sheet = [[MKActionSheet alloc] initWithTitle:title buttonTitleArray:titleArray];
    sheet.needCancelButton = isNeedCancelButton;
    sheet.maxShowButtonCount = maxShowBtnCount;
    [sheet showWithBlock:block];
}

+ (void)sheetWithTitle:(NSString*)title buttonTitleArray:(NSArray *)titleArray block:(MKActionSheetBlock)block{
    MKActionSheet *sheet = [[MKActionSheet alloc] initWithTitle:title buttonTitleArray:titleArray];
    [sheet showWithBlock:block];
}
...
- (void)initData{
    ...
    _buttonTitleFont = [UIFont systemFontOfSize:17.0f];
    _buttonOpacity = 0.6;
    _buttonHeight = 48.0f;
