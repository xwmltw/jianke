...
- (void)prepare{
    ...
    // logo
    UIImageView *arrow = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"v240_arrow_down"]];
...
- (void)placeSubviews{
    ...
    self.label.frame = CGRectMake(0, 20, self.bounds.size.width, 20);
    self.arrow.bounds = CGRectMake(0, 20, self.bounds.size.width, 20);
    self.arrow.center = CGPointMake(self.bounds.size.width * 0.5, 50);
