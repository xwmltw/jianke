...
// WDViewControllerBase
#import "WDViewControllerBase.h"

@class JobModel, EPModel;
...
@interface XHMessageTableViewController : WDViewControllerBase <UITableViewDataSource, UITableViewDelegate, XHMessageTableViewControllerDelegate, XHMessageTableViewControllerDataSource, XHMessageInputViewDelegate, XHMessageTableViewCellDelegate, XHShareMenuViewDelegate, XHEmotionManagerViewDelegate, XHEmotionManagerViewDataSource, XSJEditQuickReplyDelegate, XSJPictureViewDelegate>
...
/** 相片View */
@property (nonatomic, weak, readonly) XSJPictureView *pictureView;

/** 快捷回复View */
@property (nonatomic, weak, readonly) XSJEditQuickReplyView *quickAnswerView;
