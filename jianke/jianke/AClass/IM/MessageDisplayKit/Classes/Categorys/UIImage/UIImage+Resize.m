...
//    float height = thumbnailSize/self.size.width * self.size.height;
//    UIImage *resizedImage = [self resizedImageWithContentMode:UIViewContentModeScaleToFill
//                                                       bounds:CGSizeMake(thumbnailSize, height)
//                                         interpolationQuality:quality];
//    
//    // Crop out any part of the image that's larger than the thumbnail size
//    // The cropped rect must be centered on the resized image
//    // Round the origin points so that the size isn't altered when CGRectIntegral is later invoked
//    CGRect cropRect = CGRectMake(round((resizedImage.size.width - thumbnailSize) / 2),
//                                 round((resizedImage.size.height - height) / 2),
//                                 thumbnailSize,
//                                 height);
//    ================================================
